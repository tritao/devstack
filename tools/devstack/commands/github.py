...
from tools.devstack.commands.bodies import run_body_check
...
def build_sync_state(root: Path, conf, args: argparse.Namespace) -> dict[str, object]:
    ...
    return {
        ...
        "body_check": getattr(conf, "body_check", "auto"),
        "github_repo": repo,
        "base_ref": conf.base_remote_ref,
...
def cmd_gh_sync(args: argparse.Namespace) -> None:
    ...
    if plan_path:
        ...
        run_body_check(conf, select_entries(conf, getattr(args, "only", None)))
